...
import CentralizedGlobalClub from './components/CentralizedGlobalClub';
import RegionalHubs from './components/RegionalHubs';
import EventFoundry from './components/EventFoundry';
import AdvancedTicketing from './components/AdvancedTicketing';
import HyperRegionSubClubs from './components/HyperRegionSubClubs';
import LighthouseBeaconSystem from './components/LighthouseBeaconSystem';
import GamifiedEventTiers from './components/GamifiedEventTiers';
...
export default function App() {
  ...
  const renderContent = () => {
    ...
    switch (currentPath) {
      ...
      case '/global-club': return <CentralizedGlobalClub />;
      case '/regional-hubs': return <RegionalHubs />;
      case '/event-foundry': return <EventFoundry />;
      case '/advanced-ticketing': return <AdvancedTicketing />;
      case '/hyper-region-sub-clubs': return <HyperRegionSubClubs />;
      case '/lighthouse-beacon': return <LighthouseBeaconSystem />;
      case '/gamified-event-tiers': return <GamifiedEventTiers />;
