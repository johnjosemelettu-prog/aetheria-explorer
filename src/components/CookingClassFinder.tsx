...
export default function CookingClassFinder() {
    ...
    <div className="min-h-screen bg-stone-950 text-stone-50 px-6 py-20 lg:p-24 selection:bg-amber-500/30">
      <div className="max-w-7xl mx-auto">
        <motion.div 
          ...
          className="mb-16"
        >
          <h1 className="text-5xl md:text-7xl font-display font-medium tracking-tight mb-6">{t('auto.auto_cooking_class_finder_874')}</h1>
          ...
          <p className="text-xl text-stone-400 max-w-2xl leading-relaxed">
            {t('auto.auto_connect_with_the_pul_873')}
                                </p>
        </motion.div>
          ...
          {items.map((i, idx) => (
            ...
            >
              <img 
                ...
                alt={t('auto.auto_feature_item_872')}
              ...
              <div className="absolute bottom-0 left-0 p-8">
                <p className="text-emerald-400 font-mono text-xs tracking-widest uppercase mb-2">{t('auto.auto_signal__0_871')}{i}</p>
                <h3 className="text-2xl font-bold text-white mb-2">{t('auto.auto_discovery___870')}{i}</h3>
                <p className="text-stone-300 text-sm line-clamp-2">{t('auto.auto_a_next_generation_ex_869')}</p>
              </div>
            </motion.div>
          ))}
        </div>
