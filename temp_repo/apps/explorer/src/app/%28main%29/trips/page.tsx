    ...
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      ...
      {isLoading ? (
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent className="rounded-3xl">
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          This will permanently remove the itinerary for "{trip.name}".
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
        ...
        <div className="py-32 flex flex-col items-center justify-center text-center space-y-8 opacity-30">
          ...
          <h2 className="text-3xl font-black font-headline uppercase tracking-tighter italic">No Journeys Found</h2>
