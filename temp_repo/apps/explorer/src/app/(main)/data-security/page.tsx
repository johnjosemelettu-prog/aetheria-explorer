...
const securityPillars = [
  { title: "Isolated Neural Nodes", icon: Zap, desc: "AI synthesis happens in transient memory. We never 'train' models on your private journal or budget data.", color: "text-blue-600" },
            ...
            <CardContent className="p-10 space-y-12">
              <section className="space-y-6">
                ...
                <p className="text-sm text-slate-600 leading-relaxed font-medium">
                  We utilize <strong>Firebase Authentication</strong> nodes to ensure that your credentials never touch our application logic. Identity tokens are refreshed every 60 minutes.
                </p>
              </section>
              ...
              <section className="space-y-6">
                ...
                <p className="text-sm text-slate-600 leading-relaxed font-medium">
                  Your travel data is stored in user-isolated document sub-collections in <strong>Cloud Firestore</strong>. Security Rules enforce a strict 'Owner-Only' read/write access node.
                </p>
              </section>
            </CardContent>
          </Card>
