    ...
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      <header className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div className="space-y-4">
          <Badge className="bg-primary/10 text-primary border-none font-black uppercase tracking-widest py-1 px-3 text-[10px]">Collaborative Discovery</Badge>
        ...
        <Card className="border-none shadow-xl rounded-[2.5rem] bg-slate-900 text-white p-10 relative overflow-hidden group">
          ...
          <div className="space-y-4 relative z-10">
            <p className="text-slate-400 text-sm leading-relaxed font-medium">
              Aetheria events are exclusively for verified users. Organizers can set security levels and require "Proof of Arrival" via GPS to unlock private chat rooms and shared itineraries.
            </p>
