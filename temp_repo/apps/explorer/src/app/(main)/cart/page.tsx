  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      <header className="mb-12">
        <Badge className="bg-primary/10 text-primary border-none font-black uppercase tracking-widest py-1 px-3 text-[10px] mb-4">Manifest Review</Badge>
          ...
          <Card className="border-none shadow-2xl rounded-[2.5rem] bg-slate-950 text-white p-10 space-y-8 relative overflow-hidden">
            ...
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 flex items-center gap-3">
              ...
              <p className="text-[9px] text-slate-500 font-bold uppercase tracking-widest leading-relaxed">
                Settlement verified via Aetheria Smart Wallet Protocol. All imprints are permanent once authorized.
              </p>
            </div>
          </Card>
