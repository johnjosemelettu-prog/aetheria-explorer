...
export default function DashboardPage() {
  ...
  if (isLoading) return <div className="p-6 md:p-12 bg-background min-h-screen pt-safe"><Skeleton className="h-screen w-full rounded-2xl md:rounded-[3rem]" /></div>
      ...
      <div className="container mx-auto px-4 pt-6 md:pt-12">
        <header className="mb-8 md:mb-16 flex flex-col md:flex-row md:items-center justify-between gap-6 md:gap-8 animate-in fade-in duration-700">
          <div className="space-y-3 md:space-y-4">
            <Badge className="bg-primary/20 text-primary border-primary/30 font-black tracking-[0.2em] py-1 px-4 uppercase text-[9px] rounded-full w-fit">Aura Hub Active</Badge>
            <h1 className="font-headline text-3xl md:text-5xl lg:text-7xl font-black tracking-tighter leading-none italic uppercase">
              {t('dashboard.welcomeBack', { name: userProfile?.firstName || 'Explorer' })}
            </h1>
            <p className="text-xs md:text-sm text-muted-foreground font-black uppercase tracking-[0.3em] flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-10">
          <div className="lg:col-span-8 space-y-12 md:space-y-20">
            ...
            <section className="animate-in fade-in slide-in-from-bottom-10 duration-1000">
              <Card className="border-none shadow-2xl rounded-2xl md:rounded-[3rem] bg-card text-card-foreground overflow-hidden group border border-border">
                <CardHeader className="bg-slate-900 dark:bg-slate-950 text-white p-6 md:p-10 flex flex-col md:flex-row md:items-center justify-between gap-6 md:gap-8 border-b border-white/5">
                  <div className="space-y-2">
                    ...
                    <CardTitle className="text-2xl md:text-4xl font-black font-headline tracking-tighter italic uppercase">{t('dashboard.seasonPass')}</CardTitle>
                  </div>
                  <div className="md:text-right">
                    <p className="text-[9px] font-black uppercase text-slate-500 tracking-widest mb-1">{t('dashboard.xpSynthesized')}</p>
                    <p className="text-3xl md:text-5xl font-black font-headline text-primary leading-none tracking-tighter">12,450</p>
                  </div>
                </CardHeader>
                          ...
                          <CardContent className="p-6 md:p-8 flex flex-col h-full">
                            ...
                            <div className="space-y-2 flex-grow">
                              <div className="flex items-center justify-between">
                                <h3 className="text-lg md:text-xl font-black font-headline tracking-tighter leading-none text-card-foreground uppercase italic">{t(feature.titleKey)}</h3>
          ...
          <aside className="lg:col-span-4 space-y-6 md:space-y-10">
            ...
            <Card className="border-none shadow-2xl rounded-2xl md:rounded-[3rem] bg-card text-card-foreground overflow-hidden border border-border">
              ...
              <CardContent className="relative pt-0 -mt-10 md:-mt-12 px-6 md:px-8 pb-8 md:pb-10 flex flex-col items-center">
                ...
                <div className="mt-4 md:mt-6 text-center space-y-1">
                  <h3 className="text-xl md:text-2xl font-black font-headline leading-tight truncate max-w-[200px] md:max-w-[250px] uppercase italic text-foreground tracking-tighter">{userProfile?.firstName} {userProfile?.lastName}</h3>
            ...
            {/* Social Vibe Radar */}
            <Card className="border-none shadow-2xl rounded-2xl md:rounded-[3rem] bg-card text-card-foreground p-6 md:p-8 border border-border overflow-hidden relative">
