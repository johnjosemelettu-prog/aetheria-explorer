...
export default function ProfilePage() {
  ...
  const form = useForm<z.infer<typeof profileSchema>>({
    ...
    defaultValues: {
      firstName: 'john',
      lastName: 'jose',
      email: 'johnmjosemelettu@gmail.com',
      nationality: 'Indian',
      homeBase: 'kerala,India',
      gender: '',
      preferredInterests: [],
  ...
  useEffect(() => {
    if (userProfile && !form.formState.isDirty) {
      form.reset({
        ...
        lastName: userProfile.lastName || 'jose',
        email: userProfile.email || user?.email || 'johnmjosemelettu@gmail.com',
        nationality: userProfile.nationality || 'Indian',
        homeBase: userProfile.homeBase || 'kerala,India',
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input placeholder="Indian" {...field} className="rounded-xl border-slate-100 bg-slate-50 font-bold h-12" />
                                </FormControl>
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input placeholder="kerala,India" {...field} className="rounded-xl border-slate-100 bg-slate-50 font-bold h-12" />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input placeholder="johnmjosemelettu@gmail.com" {...field} disabled className="rounded-xl border-slate-100 bg-slate-100 dark:bg-slate-800 h-12 opacity-60" />
                              </FormControl>
