...
export const FirebaseProvider: React.FC<FirebaseProviderProps> = ({
  ...
  useEffect(() => {
    ...
    return () => unsubscribe();
  }, [auth, userAuthState.user]);

  const contextValue = useMemo((): FirebaseContextState => {
    // A service is truly available only if it is non-null.
    // During SSR, these will be null.
...
/**
 * Main hook to access Firebase services and auth state.
