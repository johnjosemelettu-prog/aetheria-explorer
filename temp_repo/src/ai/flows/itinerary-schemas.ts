...
export const GeneratePersonalizedItineraryInputSchema = z.object({
  ...
  vibe: z.string().optional().describe("The user's current mood or desired psychological vibe for the trip (e.g., 'adventurous and exciting', 'calm and rejuvenating', 'intellectually stimulating'). This is a key input for the psychological analysis."),
    ...
    .array(
      z.object({
        ...
        activities:
          z.array(
            z.object({
              time: z.string().describe('Suggested time for the activity (e.g., "9:00 AM", "Lunch", "Evening").'),
              description: z.string().describe('Description of the activity, including location and details.'),
            })
